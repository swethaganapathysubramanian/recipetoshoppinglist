...
export const highlightSelected = (id, prevId = '') => {
    ...
    if (prevId && prevSelectedItem) {
    //Remove the previous highlighting.
        prevSelectedItem.classList.remove('results__link--active');
    }
    //Highlight the currently selected recipe.
       ...
       <li>
        <a class="results__link" href="#${recipe.id}">
            ...
            <div class="results__data">
                ...
                <p class="results__time">Preparation Time: ${recipe.readyInMinutes}</p>
            </div>
        </a>
    </li>
    `;
